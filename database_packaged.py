...
def get_data_dir():
    ...
    En mode dev : utilise le dossier courant
    En mode packagé : utilise le dossier approprié de l'OS
    """
    # Vérifier si on est en mode packagé (exécutable)
...
class Database:
    def __init__(self, db_name: str = "ordifacile.db"):
        # Utiliser le bon répertoire selon le mode
